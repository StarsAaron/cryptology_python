...
def attemptHackWithKeyLength(ciphertext, mostLikelyKeyLength):
    ...
    for nth in range(1, mostLikelyKeyLength + 1):
        ...
        # See the englishFreqMatchScore() comments in freqAnalysis字母出现频率统计.py.
        freqScores = []
        for possibleKey in LETTERS:
            decryptedText = vigenereCipher.decryptMessage(possibleKey, nthLetters)
            keyAndFreqMatchTuple = (possibleKey, freqAnalysis字母出现频率统计.englishFreqMatchScore(decryptedText))
